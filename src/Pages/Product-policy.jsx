  ...
  return (
    <SectionContainer >
        <div className=" mx-auto p-6 bg-white rounded-lg">
            <h1 className="text-2xl font-bold mb-2">QUSTODIO FAMILY PRIVACY POLICY</h1>
            <h2 className="text-lg font-normal mb-4">Last Updated: 28 October, 2023</h2>

            <p className="mb-4">
                Qustodio Technologies SL (“Qustodio”, the “Company”, or “we/us”) is committed to respecting and protecting your privacy and that of your Users. This Privacy Policy explains our practices regarding the use of personal data collected and processed through our 
                <a href="https://www.qustodio.com/en/family/terms" className="text-blue-600 hover:underline  inline"> Qustodio Family Services</a> (the “Services” or “Qustodio Services”). This Privacy Policy integrates our conditions of use of our Services.
            </p>
            <p className="mb-4">
                In this Privacy Policy we will explain our practices regarding the use of personal data obtained and/or processed through our Qustodio Services.
            </p>
            <p className="mb-4">
                This Privacy Policy is part of our 
                <a href="https://www.qustodio.com/en/family/terms" className="text-blue-600 hover:underline  inline"> Qustodio Family Terms of Service</a>.
            </p>

            <h2 className="font-bold mt-6 mb-2">Summary</h2>
            <p className="mb-4">
                Qustodio processes two types of personal data in relation to the Services: 
                <ol className="list-decimal ml-6 mb-4">
                    ...
                    <li>Your User Data, collected from your monitored devices associated with your User Accounts (“Monitored Devices”), for which you are responsible (as Data Controller as defined under GDPR), while Qustodio acts as data processor as defined under GDPR or as a service provider as defined under CCPA.</li>
                </ol>
            </p>
            ...
            <p className="mb-4">
                The Qustodio Services is designed for use in a household environment by parents and not by children, and we do not knowingly collect personal information directly from children under the age of 13. You warrant that (a) you have informed any Users that are 14 years old or more that the Monitored Devices used by them include control and monitoring software and have obtained authorization from such Users for this kind of activity or (b) there are rules in your country that exempt you from the aforementioned obligation of information and consent, or provides for a different age limit, in which case that age limit will apply. Both Qustodio and you agree to fully comply with this Privacy Policy.
            </p>

            <h2 className="font-bold mt-6 mb-2">A. DATA PROCESSED BY QUSTODIO AS DATA CONTROLLER</h2>
            <p className="mb-4">
            ...
            <ol className="list-decimal ml-6 mb-4">
                ...
                <p className="ml-4">The Data Controller is Qustodio Technologies SL, Roger de Flor 193, bajos, 08013, Barcelona, Spain. You can contact our Data Protection Officer to send any suggestions, queries, doubts or complaints about personal data, or to access your personal data by writing to: <a href="mailto:dpo@qustodio.com" className="text-blue-600 hover:underline inline">dpo@qustodio.com</a>.</p>

                <li className="font-bold">Data collection by the Company through the Services</li>
                <p className="ml-4">
                    <strong>Data Collection:</strong> Qustodio will collect and process as data controller the following personal data through the Services:
                </p>
                <ul className="list-disc ml-6 mb-4">
                    <li>
                ...
                <p className="ml-4">To comply with the CCPA, a business must describe the categories of personal information it has collected about consumers during the past twelve (12) months. Accordingly, this section applies to visitors, users, and others accessing the Qustodio Services who reside in the State of California.</p>
            ...
            <h2 className="font-bold mt-6 mb-2">B. DATA PROCESSED BY QUSTODIO AS DATA PROCESSOR</h2>
            <ol className="list-decimal ml-6 mb-4">
                <li className="font-bold">General Description of the Data Processed</li>
                <p className="ml-4">When you register with Qustodio and create a User Account, you can link it to monitored devices (“Monitored Devices”), where you will be able to view information and reports from each User’s activity on those devices.</p>
                ...
                <p className="ml-4">Qustodio processes this information solely on your behalf and according to your instructions in the configuration settings of your account. You can modify the instructions or configurations at any time through the parental control panel.</p>
                ...
                <p className="ml-4">Qustodio is committed to ensuring that your User Data is secure. We have put in place appropriate technical and organizational measures to prevent unauthorized access, disclosure, alteration, or destruction of your User Data.</p>
            ...
            <p className="mb-4">If you are using the Qustodio Service to see data about your User’s usage of school devices collected by Linewize Inc. through its service School Manager, please be informed that the personal data collected by Linewize is subject to Linewize’s privacy policy.</p>
            ...
            <p className="mb-4">To exercise these rights, please contact us at <a href="mailto:dpo@qustodio.com" className="text-blue-600 hover:underline inline ">dpo@qustodio.com</a>.</p>
            ...
            <p className="ml-4">By email: <a href="mailto:dpo@qustodio.com" className="text-blue-600 hover:underline inline ">dpo@qustodio.com</a></p>
            <p className="ml-4">By mail: Qustodio Technologies SL, Roger de Flor 193, bajos, 08013, Barcelona, Spain</p>
      ...
      <p className="mt-4">
        For more information about our service providers that carry out international data transfers, please contact <a href="mailto:dpo@qustodio.com" className="text-blue-600 hover:underline inline ">dpo@qustodio.com</a>.
      </p>
      ...
      <p>
        ...
        <a href="mailto:dpo@qustodio.com" className="text-blue-600 hover:underline inline "> dpo@qustodio.com</a> 
        or send a letter to Qustodio Technologies SL, Roger de Flor 193, bajos, 08013, Barcelona, Spain.
      </p>
      <p>
      ...
      <ul className="list-disc list-inside space-y-2">
        <li>Emailing us at <a href="mailto:dpo@qustodio.com" className="text-blue-600 hover:underline inline ">dpo@qustodio.com</a></li>
        <li>Submitting a support request within the Qustodio Services.</li>
      </ul>
      <p>
        Only you, or someone legally authorized to act on your behalf, may make a request to know or delete related to your personal information. To designate an authorized agent, please submit a request by emailing us at <a href="mailto:dpo@qustodio.com" className="text-blue-600 hover:underline inline ">dpo@qustodio.com</a>.
      </p>
      <p>
        You may also make a request to know or delete on behalf of your child by emailing us at <a href="mailto:dpo@qustodio.com" className="text-blue-600 hover:underline inline ">dpo@qustodio.com</a>.
      </p>
      ...
      <h2 className="text-xl font-semibold mt-6">Qustodio Processing User Data as Data Processor/Service Provider</h2>
      <p>
        When registering and creating an Account, Qustodio starts collecting data from the Devices associated with the Account, which may include personal data relating to you, Users of the Devices, or third parties (“<b>User Data</b>”, including information about your Devices, websites and apps that your Users use, contacts, connections, payments, messages and other communications, posted and received content, etc.). Furthermore, in the event of any promotional or other campaign, Qustodio may process the contact information (name and email address) of a potential new client or user of our Services you provide us with.
      </p>
      <p>
      ...
      <p>
        The purpose of this section is to regulate the processing of the User Data indicated in Appendix 1, that you make available to Qustodio for us to provide you with the Qustodio Service. The term of validity of this section is established by virtue of your subscription with Qustodio.
      </p>
      ...
      <p>
        The Client is responsible for setting the parental control panel configurations on the Qustodio Platform that control the Services, the supervision and monitoring of activities, and determines the personal data to be covered. The installation of the Qustodio Device Software and your configuration of the control panel constitute instructions for us to process User Data on your behalf. The level and degree of such surveillance and monitoring are entirely under your control, and we will not be liable for any such configuration and control carried out by you. Furthermore, your support requests via email or phone also constitute instructions for us to process User Data, as long as processing User Data is necessary to help you with your request.
      </p>
      ...
      <p>
        During your subscription, we generally retain your User Data on an identifiable basis for 12-month periods, for providing our annual behavior report. Through the Platform control panel, you may delete all historical data saved at any time. This data will no longer be accessible and will be fully removed from our systems on the next back-up. If you wish to remove all the User Data in your Qustodio Account, please uninstall Qustodio from your devices and send an email, with a digital copy of your ID or other identification document to prove your identity, requiring the deletion of all the data we have about you and your Users. Once your identity is confirmed, we will immediately remove all Data from our active systems and back-ups within fifteen (15) days from confirmation of identity.
      </p>

      <h2 className="text-xl font-semibold mt-6">7. Rights and Responsibilities of Qustodio as Data Processor</h2>
      ...
      <p className="font-normal mb-2">
            ...
            <ol className="list-decimal list-inside mt-4">
                ...
                <p className="font-normal">
                    For all entities outside the Economic European Area, we have entered contracts with such entities that do include such safeguards, including the EC model clauses (see Section A.3 above and Appendix 1 below for a list of these entities). For more information, please contact <a href="mailto:dpo@qustodio.com" className="text-blue-600 inline ">dpo@qustodio.com</a>.
                </p>
            </ol>
            <ol className="list-decimal list-inside mt-4">
            ...
            <table className="mt-6 w-full border-collapse border border-gray-300">
                <tbody>
                    ...
                    <tr>
                        <td colSpan="2" className="border border-gray-300 p-4">
                            <b>For CCPA compliance purposes, Qustodio has collected the following types of personal data/information from the consumers described below within the past twelve months. Under the GDPR, the data indicated below are data that Qustodio processes as data processor.</b>
                        </td>
                    </tr>
                    <tr>
                        <td className="border border-gray-300 p-4"><b>Categories of Data Subjects/consumers</b></td>
                        <td className="border border-gray-300 p-4">Users of the devices which are monitored by Qustodio. Third parties who interact with the users of such devices.</td>
                    </tr>
                    <tr>
                        ...
                        <td className="border border-gray-300 p-4">
                            ...
                            <p>(c) Technical information about the Monitored Device, such as the model ID. For iOS devices, after installing the MDM profile, Qustodio will have access to all the traffic of the device. This information (coming from the device) only goes to Qustodio servers and is not shared with any third party. The specific information collected through MDM is:</p>
            ...
            <ul className="list-disc list-inside">
                <li><b>Amazon Inc.</b> provides Qustodio the service of data hosting outside the European Economic Area (USA).</li>
                <li><b>ZenDesk Inc.</b> provides Qustodio with support services outside the European Economic Area (USA).</li>
                <li>The third parties indicated in section A.3 for the provision of their services.</li>
            </ul>
            <p className="mt-6 font-bold">C. DATA COLLECTED THROUGH SCHOOL MANAGER AND SHOWN VIA THE QUSTODIO SERVICE</p>
            <p>
                If your child’s school subscribed to Linewize Inc’s service “School Manager”, you may be able to see data about your child’s usage of the school’s devices (“School Manager Data”) on the Qustodio Service.
            </p>
            <p>
            ...
            <p>
                Should you have any questions on how School Manager processes your child’s data, please contact <a href="mailto:privacy@qoria.com" className="text-blue-600 inline">privacy@qoria.com</a>.
            </p>
        </div>
    </SectionContainer>
  )
