  ...
  return (
    <SectionContainer >
        <div className=" mx-auto p-6 bg-white rounded-lg">
            ...
            <h2 className="text-lg font-normal mb-4">Last Updated: 28 October, 2023</h2>

            <p className="mb-4">
                GuardMyKids Technologies SL (“GuardMyKids”, the “Company”, or “we/us”) is committed to respecting and protecting your privacy and that of your Users. This Privacy Policy explains our practices regarding the use of personal data collected and processed through our 
                <a href="#" className="text-blue-600 hover:underline  inline"> GuardMyKids Family Services</a> (the “Services” or “GuardMyKids Services”). This Privacy Policy integrates our conditions of use of our Services.
            </p>
            <p className="mb-4">
                In this Privacy Policy we will explain our practices regarding the use of personal data obtained and/or processed through our GuardMyKids Services.
            </p>
            <p className="mb-4">
                This Privacy Policy is part of our 
                <a href="#" className="text-blue-600 hover:underline  inline"> GuardMyKids Family Terms of Service</a>.
            </p>

            <h2 className="font-bold mt-6 mb-2">Summary</h2>
            <p className="mb-4">
                GuardMyKids processes two types of personal data in relation to the Services: 
                <ol className="list-decimal ml-6 mb-4">
                    ...
                    <li>Your User Data, collected from your monitored devices associated with your User Accounts (“Monitored Devices”), for which you are responsible (as Data Controller as defined under GDPR), while GuardMyKids acts as data processor as defined under GDPR or as a service provider as defined under CCPA.</li>
                </ol>
            </p>
            ...
            <p className="mb-4">
                Read more about COPPA at the FTC’s COPPA page. This regulation is designed to protect the privacy of your children. In order for a child under the age of 13 located in the United States to use the GuardMyKids Services, his/her parent or teacher must approve the registration.
            </p>
            <p className="mb-4">
                The GuardMyKids Services is designed for use in a household environment by parents and not by children, and we do not knowingly collect personal information directly from children under the age of 13. You warrant that (a) you have informed any Users that are 14 years old or more that the Monitored Devices used by them include control and monitoring software and have obtained authorization from such Users for this kind of activity or (b) there are rules in your country that exempt you from the aforementioned obligation of information and consent, or provides for a different age limit, in which case that age limit will apply. Both GuardMyKids and you agree to fully comply with this Privacy Policy.
            </p>

            <h2 className="font-bold mt-6 mb-2">A. DATA PROCESSED BY GUARDMYKIDS AS DATA CONTROLLER</h2>
            <p className="mb-4">
                Please note that this Section does NOT regulate the processing of user data from the Monitored Devices (“User Data”) by GuardMyKids in its capacity as Processor, which is regulated by Section B attached.
            </p>
            <ol className="list-decimal ml-6 mb-4">
                <li className="font-bold">Data Controller</li>
                <p className="ml-4">The Data Controller is GuardMyKids Technologies SL, Roger de Flor 193, bajos, 08013, Barcelona, Spain. You can contact our Data Protection Officer to send any suggestions, queries, doubts or complaints about personal data, or to access your personal data by writing to: <a href="mailto:Support@guardmykids.com" className="text-blue-600 hover:underline inline">Support@guardmykids.com</a>.</p>

                <li className="font-bold">Data collection by the Company through the Services</li>
                <p className="ml-4">
                    <strong>Data Collection:</strong> GuardMyKids will collect and process as data controller the following personal data through the Services:
                </p>
                <ul className="list-disc ml-6 mb-4">
                    <li>
                ...
                <p className="ml-4">To comply with the CCPA, a business must describe the categories of personal information it has collected about consumers during the past twelve (12) months. Accordingly, this section applies to visitors, users, and others accessing the GuardMyKids Services who reside in the State of California.</p>
            ...
            <ol className="list-decimal ml-6 mb-4">
                ...
                <p className="ml-4">When you register with GuardMyKids and create a User Account, you can link it to monitored devices (“Monitored Devices”), where you will be able to view information and reports from each User’s activity on those devices.</p>
                ...
                <p className="ml-4">GuardMyKids processes this information solely on your behalf and according to your instructions in the configuration settings of your account. You can modify the instructions or configurations at any time through the parental control panel.</p>
                ...
                <p className="ml-4">GuardMyKids is committed to ensuring that your User Data is secure. We have put in place appropriate technical and organizational measures to prevent unauthorized access, disclosure, alteration, or destruction of your User Data.</p>
            ...
            <p className="mb-4">If you are using the GuardMyKids Service to see data about your User’s usage of school devices collected by Linewize Inc. through its service School Manager, please be informed that the personal data collected by Linewize is subject to Linewize’s privacy policy.</p>
            ...
            <p className="mb-4">To exercise these rights, please contact us at <a href="mailto:Support@guardmykids.com" className="text-blue-600 hover:underline inline ">Support@guardmykids.com</a>.</p>
            ...
            <p className="ml-4">By mail: GuardMyKids Technologies SL, Roger de Flor 193, bajos, 08013, Barcelona, Spain</p>
      ...
      <p>
        ...
        or send a letter to GuardMyKids Technologies SL, Roger de Flor 193, bajos, 08013, Barcelona, Spain.
      </p>
      <p>
      ...
      <ul className="list-disc list-inside space-y-2">
        ...
        <li>Submitting a support request within the GuardMyKids Services.</li>
      </ul>
      <p>
      ...
      <h2 className="text-xl font-semibold mt-6">GuardMyKids Processing User Data as Data Processor/Service Provider</h2>
      <p>
        When registering and creating an Account, GuardMyKids starts collecting data from the Devices associated with the Account, which may include personal data relating to you, Users of the Devices, or third parties (“<b>User Data</b>”, including information about your Devices, websites and apps that your Users use, contacts, connections, payments, messages and other communications, posted and received content, etc.). Furthermore, in the event of any promotional or other campaign, GuardMyKids may process the contact information (name and email address) of a potential new client or user of our Services you provide us with.
      </p>
      <p>
      ...
      <p>
        The purpose of this section is to regulate the processing of the User Data indicated in Appendix 1, that you make available to GuardMyKids for us to provide you with the GuardMyKids Service. The term of validity of this section is established by virtue of your subscription with GuardMyKids.
      </p>
      ...
      <p>
        The Client is responsible for setting the parental control panel configurations on the GuardMyKids Platform that control the Services, the supervision and monitoring of activities, and determines the personal data to be covered. The installation of the GuardMyKids Device Software and your configuration of the control panel constitute instructions for us to process User Data on your behalf. The level and degree of such surveillance and monitoring are entirely under your control, and we will not be liable for any such configuration and control carried out by you. Furthermore, your support requests via email or phone also constitute instructions for us to process User Data, as long as processing User Data is necessary to help you with your request.
      </p>
      ...
      <p>
        During your subscription, we generally retain your User Data on an identifiable basis for 12-month periods, for providing our annual behavior report. Through the Platform control panel, you may delete all historical data saved at any time. This data will no longer be accessible and will be fully removed from our systems on the next back-up. If you wish to remove all the User Data in your GuardMyKids Account, please uninstall GuardMyKids from your devices and send an email, with a digital copy of your ID or other identification document to prove your identity, requiring the deletion of all the data we have about you and your Users. Once your identity is confirmed, we will immediately remove all Data from our active systems and back-ups within fifteen (15) days from confirmation of identity.
      </p>

      <h2 className="text-xl font-semibold mt-6">7. Rights and Responsibilities of GuardMyKids as Data Processor</h2>

      <p className="font-normal mb-2">
                As established in the applicable laws and regulations, GuardMyKids shall:
            </p>
            <div className="pl-10">
                <p className="text-lg">
                    a) Process User Data only on the basis of documented instructions from you, including transfers of User Data to a third country or international organization, unless otherwise required to do so under Union law or applicable Member State law. In such case, GuardMyKids will inform you of that legal requirement prior to the processing, unless otherwise prohibited by such law or in the public interest.
                </p>
                <p className="text-lg">
                ...
                <p className="text-lg">
                    f) Assist you in ensuring that you comply with your privacy obligations, if any, taking into account the nature of the processing and the information that is available to GuardMyKids.
                </p>
                <p className="text-lg">
                ...
                <p className="text-lg">
                    i) Process the User Data placed at the disposal of GuardMyKids in a way that ensures that the personnel in charge follows Your instructions.
                </p>
                <p className="text-lg">
            ...
            <ol className="list-decimal list-inside mt-4">
                ...
                <p className="font-normal">
                    Insofar as there exists an instruction from a competent supervisory authority, a development of a national legislation or a delegated act, in the event of a security breach of the personal data, GuardMyKids shall notify you and the competent supervisory authority of such breach without undue delay, and if possible, no later than seventy-two (72) hours after it happened.
                </p>
            </ol>
            <ol className="list-decimal list-inside mt-4">
                <li className="font-bold">Termination, Resolution &amp; Expiration.</li>
                <p className="font-normal">
                    In the event of termination, resolution or expiration of the contractual relationship for the provision of services hereunder between you and GuardMyKids, the latter shall not keep the User Data unless otherwise legally required or advisable to do so. Otherwise, upon termination, resolution or expiration, or when no longer legally required to keep the data, GuardMyKids shall destroy or return to the Client all personal data and any copies of it, as well as any support or other document containing any personal data. This is without prejudice to the right of GuardMyKids to continue to process User Data where such data is being processed by GuardMyKids or for the defense of its legal interests.
                </p>
            </ol>
            <ol className="list-decimal list-inside mt-4">
                <li className="font-bold">Changes to Our Privacy Policy</li>
                <p className="font-normal">
                    We reserve the right to amend this privacy policy at our discretion and at any time. When we make changes to this privacy policy, we will post the updated notice on the Application and update the notice’s effective date. <b>Your continued use of the GuardMyKids Services following the posting of changes constitutes your acceptance of such changes.</b>
                </p>
            </ol>
            <table className="mt-6 w-full border-collapse border border-gray-300">
                <tbody>
                    ...
                    <tr>
                        <td colSpan="2" className="border border-gray-300 p-4">
                            <b>For CCPA compliance purposes, GuardMyKids has collected the following types of personal data/information from the consumers described below within the past twelve months. Under the GDPR, the data indicated below are data that GuardMyKids processes as data processor.</b>
                        </td>
                    </tr>
                    <tr>
                        <td className="border border-gray-300 p-4"><b>Categories of Data Subjects/consumers</b></td>
                        <td className="border border-gray-300 p-4">Users of the devices which are monitored by GuardMyKids. Third parties who interact with the users of such devices.</td>
                    </tr>
                    <tr>
                        ...
                        <td className="border border-gray-300 p-4">
                            ...
                            <p>(c) Technical information about the Monitored Device, such as the model ID. For iOS devices, after installing the MDM profile, GuardMyKids will have access to all the traffic of the device. This information (coming from the device) only goes to GuardMyKids servers and is not shared with any third party. The specific information collected through MDM is:</p>
            ...
            <ul className="list-disc list-inside">
                <li><b>Amazon Inc.</b> provides GuardMyKids the service of data hosting outside the European Economic Area (USA).</li>
                <li><b>ZenDesk Inc.</b> provides GuardMyKids with support services outside the European Economic Area (USA).</li>
            ...
            <p>
                If your child’s school subscribed to Linewize Inc’s service “School Manager”, you may be able to see data about your child’s usage of the school’s devices (“School Manager Data”) on the GuardMyKids Service.
            </p>
            <p>
            ...
            <p>
                GuardMyKids processes the School Manager Data as a data subprocessor for Linewize, solely for the purpose of presenting those data to you via our user interface, under the instructions of the school. We treat all data we process with utmost confidentiality under the same conditions as indicated above for our GuardMyKids Service. We inform you that in order to present the School Manager Data via our user interface, we use certain IT service suppliers indicated above who process the data for us (support, data management and analysis and user experience management).
            </p>
            <p>
