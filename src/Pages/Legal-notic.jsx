  ...
  return (
        <SectionContainer >
            <div className='text-gray-700 text-lg font-medium my-10 md:my-20 text-center md:text-start'>
                ...
                <p className="py-4">
                    You are accessing the website of GuardMyKids Technologies S.L. (“GuardMyKids”, the “Company” or “we/us”) available at 
                ...
                <p className="pt-1 pb-2" >
                    GuardMyKids Technologies S.L. is domiciled at Roger de Flor Street, 193, 08013 Barcelona, Spain, has Spanish tax number B-65825523, and is registered in the Companies Registry of Barcelona, volume 38188, Sheet B322132, page 78. You can contact us at: 
                ...
                <h2 className='text-2xl font-semibold pt-8'>GuardMyKids Family Services</h2>
                <p className="py-4">The services offered by GuardMyKids Family are regulated by the specific <a href='#' className="text-blue-500 hover:underline inline ">Terms and Conditions </a> and <a href='#' className="text-blue-500 hover:underline inline ">Privacy Policy</a>.</p>
