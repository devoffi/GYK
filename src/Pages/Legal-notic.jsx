        ...
        <SectionContainer >
            <div className='text-gray-700 text-lg font-medium my-10 md:my-20 text-center md:text-start'>
                ...
                <p className="pt-1 pb-2" >
                    Safekidly Technologies is domiciled at 1st floor here showroom building, Raithupeta, Nandigama, NTR District, Andhra Pradesh, India, has Spanish tax number B-65825523, and is registered in the Companies Registry of Barcelona, volume 38188, Sheet B322132, page 78. You can contact us at: 
