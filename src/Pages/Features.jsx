  ...
  return (
    <SectionContainer>
      ...
      <div className="flex flex-wrap gap-6 lg:w-[90%] mx-auto">
        <div className="hidden md:flex md:flex-wrap gap-6 ">
          <p
            ...
            onClick={() => scrollToSection(filterRef)}>
            Filter content & apps
          </p>
          <p
            className="px-4 py-2 border rounded-full cursor-pointer "
          ...
          <p
            className="px-4 py-2 border rounded-full cursor-pointer "
            onClick={() => scrollToSection(timeLimitsRef)}>
            Set time limits
          </p>
          <p
            className="px-4 py-2 border rounded-full cursor-pointer "
            onClick={() => scrollToSection(locateFamilyRef)}>
            Locate family
          </p>
          <p
            className="px-4 py-2 border rounded-full cursor-pointer "
            onClick={() => scrollToSection(trackCallsRef)}>
            Track calls & SMS
          </p>
          <p
            className="px-4 py-2 border rounded-full cursor-pointer "
        ...
        <div className="md:hidden flex overflow-x-auto scrollbar-hidden scrollbar-hide gap-2">
          <p className="px-2 text-sm py-2 border rounded-full whitespace-nowrap">
            Filter content & apps
          </p>
          <p className="px-2 text-sm py-2 border rounded-full whitespace-nowrap">
            Monitor activity
      ...
      <div className="flex flex-col gap-10 lg:w-full mx-auto">
        <div
          ref={filterRef}
          className="flex flex-col lg:flex-row bg-blue-50 rounded-xl p-4 md:p-16 my-10 justify-center items-center lg:gap-32 gap-10">
          <div>
            ...
            <p className="text-lg pl-12">
              ...
              violence, and other threats. Receive alerts when they try to
        ...
        <div
          ...
          <div>
            ...
            <p className="text-lg pl-12">
              Log in to the real-time dashboard from any device at any time to
              check your child’s digital activity and adjust your settings.
              Easily view their activity timeline, browsing history, YouTube
              views, screen time, and more.
            </p>
          </div>
        </div>
        ...
        <div
          ref={timeLimitsRef}
          className="flex flex-col lg:flex-row justify-center items-center bg-blue-50 rounded-xl p-4 md:p-16 my-10 lg:gap-32 gap-10">
          <div>
            <p className="text-xl flex gap-3 lg:text-4xl font-bold mt-8">
              <FaRegClock />
            ...
            <p className="text-lg pl-12">
              Prevent screen addiction, preserve family time, and encourage
              healthy sleep patterns with consistent time limits and routines
              that you can easily switch between. Plus, pause the internet at
        ...
        <div
          ...
          <div>
            ...
            <p className="text-lg pl-12">
              Spot your child on the map to know where they are and have been.
              Save the most visited places like school and home and get peace of
              mind by receiving notifications when they arrive or leave those
              locations.
            </p>
          </div>
        </div>
        ...
        <div
          ref={trackCallsRef}
          className="flex flex-col lg:flex-row justify-center items-center bg-blue-50 rounded-xl p-4 md:p-16 my-10 lg:gap-20 gap-10">
          <div>
            <p className="text-xl flex gap-3 lg:text-4xl font-bold mt-8">
              <IoCallOutline />
            ...
            <p className="text-lg pl-12">
              Detect suspicious contacts by seeing who your child exchanges
              calls and messages with. Read the texts they send and receive,
              plus set a list of blocked phone numbers.
            </p>
            <p className="text-xs p-6">
              ** Calls and messages for iOS requires a Windows or Mac computer
            </p>
          </div>
          <div>
            <video autoPlay muted loop type="webm">
        ...
        <div
          ...
          <div>
            ...
            <p className="text-lg pl-12">
              Receive detailed daily, weekly, and monthly reports of your
              child’s online activity straight to your inbox. Real-time alerts
              mean you’ll know as soon as they try to access blocked websites or
              are in trouble.
            </p>
          </div>
        </div>
        ...
        <p className="text-lg lg:text-xl text-center my-5">
          Click on the icons below for more information on the features we
          provide for each platform
        </p>
