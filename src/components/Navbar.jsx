      ...
      <div className="py-3 transition-all duration-300 container m-auto flex items-center justify-between ">
        <div className="flex text-xl sm:text-2xl uppercase font-semibold cursor-pointer"  onClick={navigate('/')}>
          ...
          <span className="text-xs flex  items-end pb-1 lowercase">.com</span> */}
           <img src={logo} alt="courses" className='w-30 h-12 rounded-sm shadow-2xl  object-cover'/>
        </div>
        <div
          className={`${
            toggle
          ...
          <div className="flex flex-col md:flex-row items-center gap-10  sm:text-lg text-md">
            ...
            <div
              ...
              <div
                className={` absolute  z-10 mt-0  origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none  ${ product ? "" : "hidden" }  `}
                tabindex="-1"
                style={{
                  left: "50%",
                ...
                <div class="py-1 w-full" role="none">
                  ...
                  <div class=" flex px-4 py-2 text-sm text-gray-700 w-full gap-5"  role="menuitem"  tabindex="-1"  id="menu-item-0">
            ...
            <div
              ...
              <div
                className={` absolute  z-10 mt-0  origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none  ${ learn ? "" : "hidden" }  `}
                tabindex="-1"
                style={{
                  left: "50%",
                  transform: "translateX(-50%)",
            ...
            <div
              ...
              <div
                className={` absolute z-10 mt-0  origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none  ${ support ? " " : "hidden" }  `}
                tabindex="-1"
                style={{
                  left: "50%",
                  ...
                  <div class=" flex px-4 py-2 text-sm text-gray-700 w-full gap-5"  >
                    <div className='category bg-white px-2 pb-4 shadow-xl rounded-md flex items-center  justify-between border border-transparent hover:bg-gray-50 hover:border-[#1a9068] hover:cursor-pointer group/edit' style={{width : "365px"}}>
                        ...
                        <div className="rounded-lg  group-hover">
                            ...
                            <p className="text-xs">
                                Step-by-step guides and videos to help you set up, use, and troubleshoot Qustodia
                            </p>
                        </div>
                        <BsArrowUpRight size={13} style={{ color:'#1a9068' }} className='icon items-start mt-7 '/>
                    </div>
